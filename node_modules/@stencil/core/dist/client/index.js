...
const patchEsm = () => {
    ...
    if (!(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return new Promise(function (resolve) { resolve(require('./css-shim-8b902b6b.js')); });
    }
...
const patchBrowser = async () => {
    ...
    if (importMeta !== '') {
        ...
        if (!window.customElements) {
            // @ts-ignore
            await new Promise(function (resolve) { resolve(require('./dom-dccd9aa5.js')); });
        }
...
const scheduleUpdate = async (elm, hostRef, cmpMeta, isInitialLoad) => {
    ...
    if (isInitialLoad) {
        if (buildConditionals.BUILD.watchCallback || buildConditionals.BUILD.hostListener) {
...
const setValue = (ref, propName, newVal, cmpMeta) => {
    ...
    if (newVal !== oldVal && (!buildConditionals.BUILD.lazyLoad || !(flags & 8 /* isConstructingInstance */) || oldVal === undefined)) {
        ...
        if (!buildConditionals.BUILD.lazyLoad || hostRef.$lazyInstance$) {
            ...
            if (buildConditionals.BUILD.watchCallback && cmpMeta.$watchers$ && flags & 128 /* isMethodsCallable */) {
    ...
    if ((buildConditionals.BUILD.lazyLoad || buildConditionals.BUILD.style) && (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if (buildConditionals.BUILD.style && !Cstr.isStyleRegistered && Cstr.style) {
            ...
            if (!buildConditionals.BUILD.hydrateServerSide && buildConditionals.BUILD.shadowDom && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await new Promise(function (resolve) { resolve(require('./shadow-css-73f95896.js')); }).then(m => m.scopeCss(style, scopeId, false));
            }

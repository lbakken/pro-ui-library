...
function canSkipOutputTargets(buildCtx) {
...
function componentDecoratorToStatic(config, typeChecker, diagnostics, cmpNode, newMembers, componentDecorator) {
...
function validateComponent(config, diagnostics, typeChecker, componentOptions, cmpNode, componentDecorator) {
...
function useCss(config, stylePath) {

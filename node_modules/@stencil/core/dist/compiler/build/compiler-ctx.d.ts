...
export declare function getModule(config: d.Config, compilerCtx: d.CompilerCtx, sourceFilePath: string): d.Module;
export declare function resetModule(moduleFile: d.Module): void;
